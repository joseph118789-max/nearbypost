...
class SourceController extends Controller
{
    ...
    public function update(Request $request, int $id): RedirectResponse
    {
        $data = $request->validate([
            ...
            'constraint_note'        => ['nullable', 'string', 'max:4000'],
            'workaround_note'        => ['nullable', 'string', 'max:4000'],
        ...
        DB::table('sources')->where('id', $id)->update([
            ...
            'constraint_note'        => $data['constraint_note'] ?: null,
            'workaround_note'        => $data['workaround_note'] ?: null,

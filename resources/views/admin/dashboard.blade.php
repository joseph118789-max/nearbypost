  ...
  <div id="subscriberTab" class="tab-content">
    <div class="header-section">
      ...
      <div class="filter-row">
        ...
        <select id="filterStatus" class="filter-input"><option value="all">All Status</option><option value="active">Active</option><option value="pending_extraction">Pending</option></select>
...
<div id="subscriberModal" class="modal-overlay">
  <div class="modal-card">
    ...
    <div class="form-group"><label>Status</label><select id="subStatus"><option value="active">Active</option><option value="pending_extraction">Pending</option></select></div>
